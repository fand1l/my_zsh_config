# Generated by Powerlevel10k configuration wizard on 2024-08-27 at 22:17 EEST.
...
() {
  ...
  # Lef prompt terminator for lines without any segments.
  ...
  typeset -g POWERLEVEL9K_USER_BACKGROUND=235
  typeset -g POWERLEVEL9K_USER_CONTENT_EXPANSION=' $user'
  ...
  typeset -g POWERLEVEL9K_STATUS_OK_VISUAL_IDENTIFIER_EXPANSION='👌 Працює'
  ...
  typeset -g POWERLEVEL9K_STATUS_OK_PIPE_VISUAL_IDENTIFIER_EXPANSION='👌 Працює'
  ...
  typeset -g POWERLEVEL9K_STATUS_ERROR_VISUAL_IDENTIFIER_EXPANSION='⛔ Щось зламалось'
  ...
  typeset -g POWERLEVEL9K_STATUS_ERROR_SIGNAL_VISUAL_IDENTIFIER_EXPANSION='⛔ Щось зламалось'
  ...
  typeset -g POWERLEVEL9K_TIME_BACKGROUND=039
